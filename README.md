# YouTube 2026 Data Pipeline

A modular and scalable Data Engineering project designed to ingest video performance data from the YouTube Dataset, store it securely in AWS S3 and PostgreSQL, transform it through dbt, orchestrate workflows using Apache Airflow, and deliver dynamic visualizations with Metabase.
